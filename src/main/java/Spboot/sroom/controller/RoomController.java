...
public class RoomController {
   ...
   public String insertRoom(HttpServletRequest request) {
	   String savePath=File.separator+"home"+File.separator+"ubuntu"+File.separator+"Shareroom"+File.separator+"target"+File.separator+"ShareRoom-0.0.1-SNAPSHOT"+File.separator+"roomImages"+File.separator;
